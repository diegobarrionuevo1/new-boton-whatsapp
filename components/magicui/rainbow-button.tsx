  ...
  return (
    <button
      ...
      className={cn(
        ...
        // before styles
        "before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(0_100%_63%),hsl(90_100%_63%),hsl(210_100%_63%),hsl(195_100%_63%),hsl(270_100%_63%))] before:[filter:blur(calc(0.8*1rem))]",
        // light mode colors
